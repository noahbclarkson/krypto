...
### Priority 2: Document Top-10 Winner Mechanism — DONE 2026-05-11

**Status:** CLOSED. Output: `memory/top10_mechanism_2026-05-11.md`.

**Key finding:** 8/10 winners entered after BTC drawdowns >10% in 21d (mean-reversion, not trend-following). Average hold 4.8 bars. Position sizing equal. Mechanism: ATR_RANK gate prevents whipsaws but "accidentally" passes rare reversals during low-vol oversold conditions. No additional entry filter can be safely added without destroying the top-10 tail.

**Rule:** All future entry filter candidates must pass a top-winner preservation audit before promotion.
