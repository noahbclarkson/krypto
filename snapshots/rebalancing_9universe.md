...
| OldGuardNoBNB | none | 5 | 5/6 | +3.601 | +80.7 | +72.1 | 165 | 47% |
| OldGuardNoBNB | close_losers | 5 | 5/6 | +7.138 | +83.3 | +72.0 | 126 | 61% |
| OldGuardNoBNB | trim_losers | 5 | 6/6 | +3.601 | +87.0 | +70.4 | 165 | 47% |
...
| LowVolume5 | none | 5 | 3/6 | +1.027 | +32.9 | +70.3 | 159 | 45% |
| LowVolume5 | close_losers | 5 | 3/6 | +4.334 | +38.0 | +70.0 | 120 | 56% |
| LowVolume5 | trim_losers | 5 | 4/6 | +1.027 | +33.9 | +68.4 | 159 | 45% |
| OldGuard4 | none | 5 | 4/6 | +2.335 | +32.9 | +70.4 | 165 | 44% |
| OldGuard4 | close_losers | 5 | 4/6 | +6.113 | +38.9 | +70.5 | 121 | 57% |
| OldGuard4 | trim_losers | 5 | 5/6 | +2.335 | +42.1 | +68.1 | 165 | 44% |

## Global Summary

| Type | Interval | Pass | Avg Sharpe | Avg Ret% | Avg DD% | Trades | WinRate |
|------|----------|------|-----------|----------|---------|--------|---------|
| none | 5 | 46/54 | +3.827 | +87.8 | +71.6 | 1455 | 51% |
| close_losers | 5 | 48/54 | +6.893 | +89.9 | +71.5 | 1135 | 63% |
| trim_losers | 5 | 51/54 | +3.827 | +81.1 | +69.9 | 1455 | 51% |

## Verdict

- **close_losers I=5**: CANDIDATE. Pass rate 48/54 (88.9%, Δ +3.7pp), Sharpe Δ +3.067, trades 1135.

- **trim_losers I=5**: CANDIDATE. Pass rate 51/54 (94.4%, Δ +9.3pp), Sharpe Δ +0.000, trades 1455.
