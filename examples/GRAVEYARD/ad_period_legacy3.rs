...
async fn main() -> Result<()> {
    println!("\n========================================================");
    println!("  HYPEROPT: A/D Period Sweep (Legacy3)");
    ...
    println!("\nDone. CSV written to snapshots/ad_period_sweep_legacy3.csv");
...
fn write_csv(results: &[PeriodResult]) -> Result<()> {
    ...
    std::fs::write("snapshots/ad_period_sweep_legacy3.csv", lines.join("\n"))?;
    Ok(())
}
