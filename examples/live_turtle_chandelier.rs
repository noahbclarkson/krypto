...
//! ```
//!
//! Validated walk-forward: 83% global pass (45/54), 100% Base5 pass (6/6) with CHAND(7,2.30)/EP=21/HM=12/ATR_ENTRY_MULT=0.00. Pre-2021 stress: 67.9% (19/28). ATR_ENTRY_MULT reverted 2026-04-25 — full sweep showed EM=0.00 wins over EM=0.85.
...
// =============================================================================
const EP: usize = 21;       // Turtle entry lookback — hyperopt 2026-04-20: EP=21 wins 43/54 (79.6%). EP=24 was tried same session but T3 held-out 2026-04-26 REVERTED it — in-sample inflation. EP=21 is original validated winner.
const CHAND_P: usize = 7;  // Chandelier ATR period — hyperopt 2026-04-21: CP=7 wins +6.9% Sharpe vs CP=11 (5.908 vs 5.526). Swept CP∈[5..60 step2] × 9 universes × 54 windows with EP=21/HM=12/ATR_ENTRY_MULT=0.00/CM=2.30. Pass rate 43/54 (79.6%, identical to CP=11). Prior CP=11 sweep used stale EP=21. See memory/hyperopt-2026-04-21-chand-period.md.
