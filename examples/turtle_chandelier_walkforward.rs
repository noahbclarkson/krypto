...
// VL=96: extensive sweep 2026-05-01 VL=1..=100 × 9 universes × 6 windows (5,400 runs).
// VL=96 wins: +5.6pp pass rate, +33.8% Sharpe, +76pp return vs VL=8 baseline.
// Plateau: VL=94-100 (all 37/54 pass = 68.5%). Previous VL=8 sweep was confirmed as
// same-harness artifact (see VL=90 concern noted 2026-04-28). VL=96 is robust global winner.
// See memory/hyperopt-2026-05-01-vol-lookback.md.
