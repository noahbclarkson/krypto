...
const ATR_ENTRY_MULT: f64 = 0.85; // hyperopt 2026-04-21 FINE SWEEP: EM=0.85 wins 44/54 (81.5%) vs EM=0.90 43/54 (79.6%). Fine sweep 11 values {0.60-1.10 step 0.05} × 9 universes × 54 windows with current production params (CHAND(7,2.25)/EP=24/HM=12). EM=0.85 avoids catastrophic W3 failure (Base5: +12.2% vs -28.3%). +3.6% Sharpe (6.12 vs 5.91). Prior EM=0.90 sweep used CHAND(P=11) — tighter Chandelier(P=7) shifts optimal EM downward. See memory/hyperopt-2026-04-21-atr-entry-mult-fine.md.
