//! T85: HEDGE_ATR_PERIOD hyperopt on CURRENT production config.
//!
//! Parameter: BTC hedge ATR period — controls how many bars of BTC TR history
//! are used to size the USDT hedge (position size × HEDGE_SIZE_MULT when
//! BTC ATR > 45th percentile of HEDGE_LOOKBACK daily true ranges).
//!
//! T75 (HOLD_MAX=12) found P=38 as winner. Current production uses HM=15,
//! HSM=0.25, ATR_ENTRY_MULT=0.00. This T85 sweep validates HAP on current
//! production config so we can confirm or reject P=38 as the stable default.
//!
//! Sweep: period = 5..=100, step 1 (96 integer values).
//! Validation: 9 universes × 6 walk-forward windows.
//! Export:
//! - snapshots/t85_hedge_atr_period_summary.csv
//! - snapshots/t85_hedge_atr_period_windows.csv
//! - snapshots/t85_hedge_atr_period_equity.csv
...
const SUMMARY_OUT: &str = "/home/ubuntu/.openclaw/workspace-krypto/krypto/snapshots/t85_hedge_atr_period_summary.csv";
const WINDOWS_OUT: &str = "/home/ubuntu/.openclaw/workspace-krypto/krypto/snapshots/t85_hedge_atr_period_windows.csv";
const EQUITY_OUT: &str = "/home/ubuntu/.openclaw/workspace-krypto/krypto/snapshots/t85_hedge_atr_period_equity.csv";
