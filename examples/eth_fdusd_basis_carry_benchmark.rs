...
async fn main() -> Result<(), Box<dyn Error>> {
    println!("Starting ETH FDUSD Basis Carry Benchmark...");
    ...
    println!("Total Rows: {}", basis.len());
    let mean_basis = basis.mean().unwrap_or(0.0) * 100.0 * 100.0;
