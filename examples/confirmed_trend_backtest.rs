...
async fn main() -> anyhow::Result<()> {
    println!("{}", "═══ CONFIRMED DYNAMIC TREND — WALK-FORWARD ═══".cyan().bold());
    ...
    for interval in &["1h", "4h", "1d"] {
        ...
        let cfg = match *interval {
            "1h" => WalkForwardConfig {
                train_bars: 4000, test_bars: 1500,
                optimizer_iterations: 200, monte_carlo_n: 200,
                ..Default::default()
            },
            "4h" => WalkForwardConfig {
                train_bars: 1500, test_bars: 500,
                optimizer_iterations: 200, monte_carlo_n: 200,
                ..Default::default()
            },
            _ => WalkForwardConfig {
                train_bars: 500, test_bars: 150,
                optimizer_iterations: 200, monte_carlo_n: 100,
                ..Default::default()
            },
        };
                ...
                Ok(r) => {
                    if r.is_robust {
                        ...
                        println!(
                            ...
                            "✅ ROBUST".green().bold(), sym, interval,
                            r.windows_passed, r.windows_total,
                            r.avg_test_sharpe, r.avg_test_return_pct,
