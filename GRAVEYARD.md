...
| VOL_LOOKBACK top-3 live rank gate (T72) | 2026-05-06 | REJECTED | Isolated live-semantics candidate with exact bot.rs entry + VL=92 dollar-volume gate collapsed Base5 replay to 1.01x / Sharpe 0.09 vs exact live 2.56x / Sharpe 0.95. Do not wire VL ranking into live bot without a new mechanism. |
