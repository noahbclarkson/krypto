...
pub const HOLD_MAX: usize = 15; // hyperopt 2026-05-07 T81: extensive sweep HM∈[5..=100 step 5] × 9 universes × 7 WF windows, current live Turtle-only config. HM=15 wins: Sharpe 1.439 (+6.5% vs HM=12=1.351), 76.7% pass (46/60), Base5 6/6 pass (100%), lowest avg DD 12.85%. HM=30 ties at 83.3% pass but Sharpe 1.351. HM=40-100 plateau confirms Turtle ATR is primary exit (identical 80.0% pass, 1.304 Sharpe). Prior HM=12 was settled on STALE CHAND(7,2.30) dual-exit config — artifact of Chandelier exit overlap. See memory/hyperopt-2026-05-07.md.
