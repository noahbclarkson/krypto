...
impl StrategyRegistry {
    ...
    fn register_defaults(&mut self) {
        ...
        self.register(
            "bollinger_reversion",
            || Box::new(BollingerReversion::new()),
        );
        ...
        self.register("adaptive_ma_crossover", || {
            Box::new(AdaptiveMaCrossover::new())
        });
        self.register("relative_strength", || {
            Box::new(RelativeStrengthStrat::new())
        });
        self.register("lead_lag", || Box::new(LeadLagStrategy::new()));
        self.register("regime_bollinger_reversion", || {
            Box::new(RegimeBollingerReversion::new())
        });
    }
...
mod tests {
    ...
    fn test_unknown_strategy_returns_none() {
        ...
        assert!(result.is_none(), "Unknown strategy should return None");
        ...
        assert!(result.is_none(), "Random name should return None");
    }
